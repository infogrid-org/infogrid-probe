...
import org.infogrid.probe.test.writableprobe.AbstractWritableProbeTest;
            ...
            AbstractTest
{
    ...
    public static void initialize()
        throws
            Exception
    {
        ClassLoader    cl       = AbstractForwardReferenceTest.class.getClassLoader();
