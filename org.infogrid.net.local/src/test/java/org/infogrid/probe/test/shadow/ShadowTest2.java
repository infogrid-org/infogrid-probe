            ...
            AbstractShadowTest
{
            ...
            Exception
    {
        ...
        checkEquals( home1.getPropertyValue( TestSubjectArea.A_X ), StringValue.create( TestApiProbe1.class.getName()), "wrong probe called" );
        ...
        checkEquals( home2.getPropertyValue( TestSubjectArea.A_X ), StringValue.create( TestApiProbe2.class.getName()), "wrong probe called" );
