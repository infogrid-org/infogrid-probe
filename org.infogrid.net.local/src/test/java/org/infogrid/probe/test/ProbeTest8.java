...
/**
  ...
  * 
  * FIXME: Currently broken, not sure why
  */
...
//    @Before
            ...
            Exception
    {
        ...
        location1 = new Breakpoint( "location1", 60000L );
        location2 = new Breakpoint( "location2", 60000L );
        location3 = new Breakpoint( "location3", 60000L );
    }
...
//    @After
     ...
     */
    private static Breakpoint location1;

    /**
     * A "breakpoint" location.
     */
    private static Breakpoint location2;

    /**
     * A "breakpoint" location.
     */
    private static Breakpoint location3;
