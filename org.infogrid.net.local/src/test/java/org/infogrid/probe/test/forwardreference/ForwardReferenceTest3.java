            ...
            AbstractForwardReferenceTest
{
            ...
            Exception
    {
        ...
        checkEquals( fwdReference.getPropertyValue( TestSubjectArea.A_X ), StringValue.create( "forwardreference" ), "ForwardReference was unexpectedly resolved: " + fwdReference.getIdentifier().toExternalForm() );
